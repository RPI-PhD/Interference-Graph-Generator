; ModuleID = 'DATASETv2/gpt35-72243.c'
...
define dso_local i32 @main() #0 {
  ...
  %15 = sub nsw i32 2021, %14
  store i32 %15, ptr %4, align 4
  %16 = call i32 (ptr, ...) @printf(ptr noundef @.str.5)
  %17 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.4, ptr noundef %5)
  %18 = call i32 (ptr, ...) @printf(ptr noundef @.str.6)
  %19 = call i64 @time(ptr noundef null) #3
  %20 = trunc i64 %19 to i32
  call void @srand(i32 noundef %20) #3
  %21 = call i32 @rand() #3
  %22 = srem i32 %21, 10
  %23 = add nsw i32 %22, 1
  ...
  %28 = getelementptr inbounds [20 x i8], ptr %2, i64 0, i64 0
  %29 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, ptr noundef %28)
...
51:                                               ; preds = %0, %49, %47, %45, %43, %41, %39, %37, %35, %33, %31
