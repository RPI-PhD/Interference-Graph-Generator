; ModuleID = 'DATASETv2/gpt4o_mini-2225.c'
...
8:                                                ; preds = %31, %6
  ...
  %10 = load i32, ptr @appointment_count, align 4
...
12:                                               ; preds = %8
  ...
  %18 = getelementptr inbounds %struct.Appointment, ptr %17, i32 0, i32 0
  %19 = getelementptr inbounds [11 x i8], ptr %18, i64 0, i64 0
  %20 = load i32, ptr %1, align 4
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [100 x %struct.Appointment], ptr @appointments, i64 0, i64 %21
  %23 = getelementptr inbounds %struct.Appointment, ptr %22, i32 0, i32 1
  %24 = getelementptr inbounds [6 x i8], ptr %23, i64 0, i64 0
  %25 = load i32, ptr %1, align 4
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds [100 x %struct.Appointment], ptr @appointments, i64 0, i64 %26
  %28 = getelementptr inbounds %struct.Appointment, ptr %27, i32 0, i32 2
  %29 = getelementptr inbounds [256 x i8], ptr %28, i64 0, i64 0
  %30 = call i32 (ptr, ...) @printf(ptr noundef @.str.10, i32 noundef %14, ptr noundef %19, ptr noundef %24, ptr noundef %29)
  br label %31
...
define dso_local void @remove_appointment() #0 {
  ...
  %3 = load i32, ptr @appointment_count, align 4
  %4 = icmp eq i32 %3, 0
...
6:                                                ; preds = %0
  ...
  %8 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.12, ptr noundef %1)
  %9 = load i32, ptr %1, align 4
  %10 = icmp slt i32 %9, 1
...
11:                                               ; preds = %6
  ...
  %13 = load i32, ptr @appointment_count, align 4
...
20:                                               ; preds = %33, %17
  ...
  %22 = load i32, ptr @appointment_count, align 4
  %23 = sub nsw i32 %22, 1
...
25:                                               ; preds = %20
  ...
  %32 = getelementptr inbounds [100 x %struct.Appointment], ptr @appointments, i64 0, i64 %31
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %28, ptr align 1 %32, i64 273, i1 false)
  br label %33
...
36:                                               ; preds = %20
  %37 = load i32, ptr @appointment_count, align 4
  %38 = add nsw i32 %37, -1
  store i32 %38, ptr @appointment_count, align 4
...
9:                                                ; preds = %31, %8
  ...
  %11 = load i32, ptr @appointment_count, align 4
...
13:                                               ; preds = %9
  ...
  %28 = getelementptr inbounds %struct.Appointment, ptr %27, i32 0, i32 2
  %29 = getelementptr inbounds [256 x i8], ptr %28, i64 0, i64 0
  %30 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef @.str.18, ptr noundef %19, ptr noundef %24, ptr noundef %29)
  br label %31
...
8:                                                ; preds = %33, %7
  ...
  %12 = getelementptr inbounds [100 x %struct.Appointment], ptr @appointments, i64 0, i64 %11
  %13 = getelementptr inbounds %struct.Appointment, ptr %12, i32 0, i32 0
  %14 = getelementptr inbounds [11 x i8], ptr %13, i64 0, i64 0
  %15 = load i32, ptr @appointment_count, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [100 x %struct.Appointment], ptr @appointments, i64 0, i64 %16
  ...
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [100 x %struct.Appointment], ptr @appointments, i64 0, i64 %21
  %23 = getelementptr inbounds %struct.Appointment, ptr %22, i32 0, i32 2
  %24 = getelementptr inbounds [256 x i8], ptr %23, i64 0, i64 0
  %25 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %9, ptr noundef @.str.22, ptr noundef %14, ptr noundef %19, ptr noundef %24)
  %26 = icmp eq i32 %25, 3
  br i1 %26, label %27, label %34

27:                                               ; preds = %8
  %28 = load i32, ptr @appointment_count, align 4
  %29 = add nsw i32 %28, 1
  store i32 %29, ptr @appointment_count, align 4
  %30 = load i32, ptr @appointment_count, align 4
...
3:                                                ; preds = %0, %21
  ...
  %11 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.12, ptr noundef %2)
...
19:                                               ; preds = %3
  %20 = call i32 (ptr, ...) @printf(ptr noundef @.str.32)
  br label %21
